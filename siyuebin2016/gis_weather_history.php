...
<script type="text/javascript">
    ...
    //点击标注弹窗
     ...
     var sContent =
	"<div id='container' style='height:300px;width:400px; solid #ccc;padding:10px;'>"+
    "</div>"
    ;
    ...
    //点击标注弹窗
     var opts2 = {
      ...
      var sContent2 = "<div id='12' style='height:300px;width:400px; solid #ccc;padding:10px;'>"+
					  "</div>";
